...
describe("migrateSettings", () => {
	...
	it("keeps a whole working install exactly as it found it", () => {
		const stored = {
			...
			zotero: { apiKey: "P9c46b0lkV2XzAoUTqPmPuGZ", useLocal: true, localKeys: { "1PUT74VpHXuE": "0".repeat(32) }, folder: "Papers", sendOverSsh: true, lastTag: "#read", sendTag: "lesen", sendSyncTag: "#read" },
			zoteroLinks: { "576dc0a6-323b-468e-bd69-a2ae6c25dbb9": { attachmentKey: "5IDIN5M2", library: "user", annotations: {} } },
