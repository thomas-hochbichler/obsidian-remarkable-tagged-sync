...
describe("migrateSettings", () => {
	...
	it("keeps a whole working install exactly as it found it", () => {
		const stored = {
			...
			zotero: { useWeb: true, apiKey: "P9c46b0lkV2XzAoUTqPmPuGZ", useLocal: true, localKeys: { "1PUT74VpHXuE": "0".repeat(32) }, folder: "Papers", sendOverSsh: true, sendTag: "lesen", groups: [] },
